...
void ActiveSubmaps2D::AddSubmap(const Eigen::Vector2f& origin) {
  ...
  LOG(INFO) << "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXorigin: " << origin; //added by Skywalker 
  ...
  LOG(INFO) << "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXmatching_submap_index_: " << matching_submap_index_;  //added by Skywalker 
  LOG(INFO) << "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXsubmaps_.size(): " << submaps_.size();  //added by Skywalker 
