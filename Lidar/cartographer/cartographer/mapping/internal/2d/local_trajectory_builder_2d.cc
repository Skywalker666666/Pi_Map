...
LocalTrajectoryBuilder2D::AddAccumulatedRangeData(
  ...
  //LOG(INFO) << "pose_prediction before local ScanMatch: " << pose_prediction;  // added by Skywalker
  ...
  //LOG(INFO) << "pose_estimate_2d after local ScanMatch: " << *pose_estimate_2d;  // added by Skywalker
  ...
  //LOG(INFO) << "pose_estimate after local ScanMatch: " << pose_estimate;  // added by Skywalker
