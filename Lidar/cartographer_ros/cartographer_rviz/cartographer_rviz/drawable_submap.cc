...
void DrawableSubmap::Update(
  ...
  //std::cout << "HERE WE GO!!!" << std::endl; // added by Skywalker
  //LOG(INFO) << "HERE WE GO!!! from LOG";  // added by Skywalker
  //LOG(INFO) << ToOgre(pose_.translation());  // added by Skywalker
  //LOG(INFO) << ToOgre(pose_.rotation());
