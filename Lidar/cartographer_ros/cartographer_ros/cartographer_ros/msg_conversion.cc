...
geometry_msgs::Transform ToGeometryMsgTransform(const Rigid3d& rigid3d) {
  ...
  //LOG(INFO) << "XYZ:!!! from LOG msg conversion";  // added by Skywalker

  //LOG(INFO) << transform.translation.x;
  //LOG(INFO) << transform.translation.y;
  //LOG(INFO) << transform.translation.z;
  //LOG(INFO) << transform.translation;

  
  
  //LOG(INFO) << "rotation:!!! from LOG msg conversion";  // added by Skywalker
  //LOG(INFO) << transform.rotation.w;
  //LOG(INFO) << transform.rotation.x;
  //LOG(INFO) << transform.rotation.y;
  //LOG(INFO) << transform.rotation.z;
